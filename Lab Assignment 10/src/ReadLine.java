...
public class ReadLine {
	public static void main(String args[])
	{
		...
		try
		{
			FileReader fr=new FileReader(new File("C://Nidhi.txt"));//Created text in the document
			BufferedReader br=new BufferedReader(fr);
			FileWriter fw=new FileWriter(new File("C://target.txt"));//Shows output in this file
